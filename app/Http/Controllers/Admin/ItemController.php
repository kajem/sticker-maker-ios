...
class ItemController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        $items = Item::query();
        $items = $items->select('items.id', 'items.name', 'items.code', 'items.thumb', 'items.tag', 'items.total_sticker', 'items.author', 'items.is_animated', 'items.status', 'items.updated_at');
