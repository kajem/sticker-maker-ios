...
class ItemController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        $items = Item::query();
        $items = $items->select('items.id', 'items.name', 'items.slug', 'items.code', 'items.thumb', 'items.thumb_bg_color', 'items.tag', 'items.total_sticker', 'items.author', 'items.is_animated', 'items.telegram_name', 'items.is_telegram_set_completed', 'items.updated_at', 'items.status');
